...
public final class PaymentRequest {
    ...
    public long amountCents;      // 1716.99 -> 171699 (calcule no parse, uma vez só)
    ...
    public PaymentRequest(byte[] requestData) {
        ...
        this.corrBytes = corr;
//        this.correlationId = new String(corr, 0, n, StandardCharsets.US_ASCII);
    }
